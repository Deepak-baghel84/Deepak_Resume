...
const chatbotResponses = {
    ...
    skills: [
        "This portfolio showcases various AI/ML skills including machine learning, deep learning, computer vision, NLP, and data science. You can find more details in the Skills section!",
        "The Skills section highlights expertise in various AI/ML domains like neural networks, computer vision, NLP, and reinforcement learning. Check out the interactive skill tree!",
    ...
    projects: [
        ...
        "Check out the Projects section to see examples of work in neural networks, computer vision, NLP, and more!"
    ],
    contact: [
